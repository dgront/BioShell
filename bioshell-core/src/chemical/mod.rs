...
//! the standard monomers are listed in the [`StandardResidueType`](StandardResidueType) enum while all other can be defined
//! as a [`ResidueType`](ResidueType) struct.
//!
mod residue_types;
