...
//! # use std::io;
//! # fn main() -> Result<(), io::Error> {
//! use bioshell_io::io::{open_file, read_delimited_columns, read_delimited_values};
//! let reader = open_file("tests/test_files/f64.csv")?;
...
//! # use std::io;
//! # fn main() -> Result<(), io::Error> {
//! use bioshell_io::io::{open_file, read_whitespace_delimited_columns, read_whitespace_delimited_values};
