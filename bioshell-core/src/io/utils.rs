...
/// # use std::io;
/// use bioshell_io::io::{open_file, read_delimited_values};
...
/// use std::io::BufReader;
/// # use std::io;
/// use bioshell_io::io::{open_file, read_delimited_columns};
/// # fn main() -> Result<(), io::Error> {
/// let txt_f64 = "1.0\t2.0\t3.0\t4.0
/// 5.0\t6.0\t7.0\t8.0
/// 9.0\t10.0\t11.0\t12.0
...
/// use bioshell_io::io::full_extension;
...
///
/// ```
/// let bioshell_main_dir = bioshell_io::io::find_bioshell_path();
...
/// - List item 2
/// ";
/// let text = bioshell_io::io::markdown_to_text(markdown);
