...
impl ResidueTypeOrder {
    ...
    pub fn index_to_letter(&self, res_id: u8) -> char {
        self.index_to_aa[res_id as usize] as char
    }

    /// Converts a residue type order index into its u8 type
    pub fn index_to_type(&self, res_id: u8) -> u8 {
        self.index_to_aa[res_id as usize]
    }
}
