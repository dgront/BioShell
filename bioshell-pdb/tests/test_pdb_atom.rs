...
mod tests {
    ...
    fn test_to_csv_string() {
        ...
        atom.atom_serial_no_1 = Some(2831);
        atom.atom_symbol_2 = "O".to_string();//O
        atom.atom_position_3 = "E".to_string();//E
        atom.atom_no_in_the_branch_4 = Some(1);//1
        atom.residue_name_7 = "GLN".to_string();//
        atom.chain_name_8 = "A".to_string();
        atom.residue_no_9 = Some(294);
        atom.coordinate_11 = Vec3::new(-27.117, 12.343, 28.479);
        atom.occupancy_12 = Some(1.0);
        atom.temperature_factor_13 = Some(9.58);
        atom.charge_of_the_atom_16 = "O".to_string();
