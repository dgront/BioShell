...
mod internal_atom_definitions_tests {
    ...
    use bioshell_pdb::nerf::{InternalAtomDefinition, InternalCoordinatesDatabase};
...
'bb ' prev ' CA ' prev ' C  ' prev ' N  ' this ' CA ' 1.458001 123.0  180.0 omega
'bb ' prev ' C  ' this ' N  ' this ' CA ' this ' C  ' 1.523258 110.0 -180.0 phi
'bb ' this ' N  ' this ' CA ' this ' C  ' next ' N  ' 1.328685 114.0  180.0 psi
...
";
    ...
    fn test_internal_definitions() {
        ...
        let def = InternalAtomDefinition::from_cif_line("'bb ' next ' N  ' this ' CA ' this ' C  ' this ' O  ' 1.231015 121.0  180.0 -").unwrap();
        assert_eq!(def.a_name, " N  ".to_string());
