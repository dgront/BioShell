...
mod cartesian_system_test {
    ...
    fn cartesian_system_test_1() {
        ...
        assert_eq_vec3!(system.get_coordinates()[0], Vec3::new(1.0, 1.0, 1.0), 0.00001);
        assert_eq_vec3!(system.get_coordinates()[1], Vec3::new(2.0, 2.0, 2.0), 0.00001);
        assert_eq_vec3!(system.get_coordinates()[2], Vec3::new(3.0, 3.0, 3.0), 0.00001);
    }
    ...
    fn cartesian_system_test_2() {
        ...
        for i in 0..3 {
            system.set_xyz(i, 3.0, 2.0, 1.0);
            assert_eq_vec3!(system.get_coordinates()[i], Vec3::new(3.0, 2.0, 1.0), 0.00001);
            system.set_vec3(i, vec);
            assert_eq_vec3!(system.get_coordinates()[0], Vec3::new(0.0, 0.0, 0.0), 0.00001);
        }
    }
    ...
    fn cartesian_system_rototranslation_test() {
        ...
        coords.add_xyz(2, 2.0, 3.0, 4.0);
        coords.add_xyz(3, 3.0, 4.0, 5.0);
        coords.add_xyz(4, 5.0, 5.0, 5.0);
        let mut system: CartesianSystem = CartesianSystem::new(coords, nbl);
        assert_eq_vec3!(system.get_coordinates()[0], Vec3::new(1.0, 1.0, 1.0), 0.00001);
        assert_eq_vec3!(system.get_coordinates()[1], Vec3::new(1.0, 2.0, 3.0), 0.00001);
        assert_eq_vec3!(system.get_coordinates()[2], Vec3::new(2.0, 3.0, 4.0), 0.00001);
        assert_eq_vec3!(system.get_coordinates()[3], Vec3::new(3.0, 4.0, 5.0), 0.00001);
        assert_eq_vec3!(system.get_coordinates()[4], Vec3::new(5.0, 5.0, 5.0), 0.00001);
        let angle = std::f32::consts::PI;
        let roto_tran =
            Rototranslation::around_axis(&system.get_coordinates()[0],
                                         &system.get_coordinates()[4],
                                         angle.into());
        for i in 1..4 {
            let mut tmp = system.get_coordinates()[i].clone();
            roto_tran.apply_mut(&mut tmp);
            system.set_vec3(i, tmp);
        }
        assert_eq_vec3!(system.get_coordinates()[1], Vec3::new(3.0, 2.0, 1.0), 0.00001);
        assert_eq_vec3!(system.get_coordinates()[2], Vec3::new(4.0, 3.0, 2.0), 0.00001);
        assert_eq_vec3!(system.get_coordinates()[3], Vec3::new(5.0, 4.0, 3.0), 0.00001);
    }
